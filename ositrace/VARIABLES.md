...
| QualityShape | ositrace | validationReport | 0 | 1 | Link to the validation report. E.g. DID of the report asset or other link types. The report should be of type 'vv-report:VvReport' according to https://github.com/GAIA-X4PLC-AAD/ontology-management-base/tree/main/vv-report/. | <http://www.w3.org/2001/XMLSchema#anyURI> | ositrace_shacl.ttl |
