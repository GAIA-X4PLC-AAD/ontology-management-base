...
- This repository becomes read-only after the release cut
- The authoritative source moves to `ASCS-eV/ontology-management-base`
- Issues and pull requests should be opened in the ASCS repository
