...
```yaml
- id: jsonld-lint
  entry: python src/utils/check_parse_jsonld.py
  
- id: turtle-lint
  entry: python src/utils/check_parse_turtle.py
```

**After:**
```yaml
- id: jsonld-lint
  entry: python3 src/tools/utils/check_parse_jsonld.py
  
- id: turtle-lint
  entry: python3 src/tools/utils/check_parse_turtle.py
```
...
### JSON-LD Parser: `src/tools/utils/check_parse_jsonld.py`

**Status:** ✅ **Working**

- **Location:** `src/tools/utils/check_parse_jsonld.py` (114 lines)
...
### Turtle Parser: `src/tools/utils/check_parse_turtle.py`

**Status:** ✅ **Working** (requires `rdflib` dependency)

- **Location:** `src/tools/utils/check_parse_turtle.py` (117 lines)
...
**JSON-LD Lint:**
```bash
$ python3 src/tools/utils/check_parse_jsonld.py --help
usage: check_parse_jsonld.py [-h] paths [paths ...]
...
**Turtle Lint:**
```bash
$ python3 src/tools/utils/check_parse_turtle.py --help
