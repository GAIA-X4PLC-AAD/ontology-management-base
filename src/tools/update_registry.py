...
Usage:
    python -m src.tools.update_registry [--release-tag TAG]
    python src/tools/update_registry.py [--release-tag TAG]
...
def generate_catalog(ontologies: Dict[str, dict], registry: dict) -> str:
    ...
    comment = ET.Comment(
        ...
        "    Auto-generated by update_registry.py - do not edit manually"
    )
