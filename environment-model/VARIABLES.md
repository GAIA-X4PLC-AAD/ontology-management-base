...
| QualityShape | environment-model | textureResolution | 0 | 1 | Specifies the maximum real texture resolution in meters. | <http://www.w3.org/2001/XMLSchema#float> | environment-model_shacl.ttl |
