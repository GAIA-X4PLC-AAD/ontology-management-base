...
> **Note:** `openlabel_ontology.ttl` is sourced from the
...
- The ontology file `openlabel_ontology.ttl` is used under the license of ASAM, which can be found here: [https://www.asam.net/license](https://www.asam.net/license).
